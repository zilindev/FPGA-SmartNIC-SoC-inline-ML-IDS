...
//
// Module: registers.v
// Project: Lab8 Network Processor (lab8)
// Description: Project specific register defines
//
//              Lab8: Convertible FIFO with ARM CPU and GPU integration
//
///////////////////////////////////////////////////////////////////////////////
...
`define DEVICE_PROJ_NAME   "Lab8 Network Processor"
`define DEVICE_PROJ_DESC   "Lab8: Convertible FIFO with ARM CPU and GPU integration"
...
`define GPU_BLOCK_ADDR_WIDTH        11
`define GPU_REG_ADDR_WIDTH          12
`define IN_ARB_BLOCK_ADDR_WIDTH     17
`define IN_ARB_REG_ADDR_WIDTH       6
`define LAB8_BLOCK_ADDR_WIDTH       17
...
// Name: gpu
// Description: GPU Coprocessor Registers
// File: projects/lab8/include/gpu.xml
`define GPU_CTRL    12'h0
`define GPU_STATUS  12'h1
...
// Name: lab8
// Description: Lab8 Network Processor: convertible FIFO with CPU/GPU integration
// File: projects/lab8/include/lab8.xml
`define LAB8_CTRL               6'h0
`define LAB8_STATUS             6'h1
`define LAB8_FIFO_MODE          6'h2
`define LAB8_FIFO_DRAIN         6'h3
`define LAB8_BRAM_ADDR          6'h4
`define LAB8_BRAM_WD_LO         6'h5
`define LAB8_BRAM_WD_HI         6'h6
`define LAB8_BRAM_WCTRL         6'h7
`define LAB8_BRAM_CMD           6'h8
`define LAB8_BRAM_RD_LO         6'h9
`define LAB8_BRAM_RD_HI         6'ha
`define LAB8_BRAM_RCTRL         6'hb
`define LAB8_CPU_CTRL           6'hc
`define LAB8_CPU_STATUS         6'hd
`define LAB8_CPU_IMEM_ADDR      6'he
`define LAB8_CPU_IMEM_WDATA     6'hf
`define LAB8_CPU_IMEM_CMD       6'h10
`define LAB8_CPU_IMEM_RDATA     6'h11
`define LAB8_CPU_DMEM_ADDR      6'h12
`define LAB8_CPU_DMEM_WDATA_LO  6'h13
`define LAB8_CPU_DMEM_WDATA_HI  6'h14
`define LAB8_CPU_DMEM_CMD       6'h15
`define LAB8_CPU_DMEM_RDATA_LO  6'h16
`define LAB8_CPU_DMEM_RDATA_HI  6'h17
`define LAB8_CPU_LA_ADDR        6'h18
`define LAB8_CPU_LA_RDATA_LO    6'h19
`define LAB8_CPU_LA_RDATA_HI    6'h1a
`define LAB8_RESERVED_1B        6'h1b
`define LAB8_RESERVED_1C        6'h1c
`define LAB8_RESERVED_1D        6'h1d
`define LAB8_RESERVED_1E        6'h1e
`define LAB8_RESERVED_1F        6'h1f
`define LAB8_GPU_CTRL           6'h20
`define LAB8_GPU_STATUS         6'h21
`define LAB8_GPU_IMEM_ADDR      6'h22
`define LAB8_GPU_IMEM_WDATA     6'h23
`define LAB8_GPU_IMEM_CMD       6'h24
`define LAB8_GPU_IMEM_RDATA     6'h25
`define LAB8_GPU_DMEM_ADDR      6'h26
`define LAB8_GPU_DMEM_WDATA_LO  6'h27
`define LAB8_GPU_DMEM_WDATA_HI  6'h28
`define LAB8_GPU_DMEM_CMD       6'h29
`define LAB8_GPU_DMEM_RDATA_LO  6'h2a
`define LAB8_GPU_DMEM_RDATA_HI  6'h2b
`define LAB8_DMA_CTRL           6'h2c
`define LAB8_DMA_FIFO_ADDR      6'h2d
`define LAB8_DMA_GPU_ADDR       6'h2e
`define LAB8_DMA_LENGTH         6'h2f
